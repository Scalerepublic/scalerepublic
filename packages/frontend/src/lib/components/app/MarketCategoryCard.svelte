...
>
	<span
		class="pointer-events-none absolute inset-y-0 left-0 w-1 bg-[var(--sector-accent)] transition-[width] duration-200 group-hover:w-1.5"
		aria-hidden="true"
	></span>
	...
	<div class="mt-4 flex items-end justify-between gap-3 pl-2">
		...
		<span
			class="inline-flex size-8 items-center justify-center border border-border text-muted-foreground transition group-hover:border-[var(--sector-accent)] group-hover:text-[var(--sector-accent)]"
		>
