	...
	<table class="w-full border-collapse text-sm">
		<thead>
			<tr class="border-b border-border bg-muted/50">
				...
				<th class="hidden px-4 py-3 text-left font-serif font-semibold text-foreground sm:table-cell">Name</th>
				<th class="px-4 py-3 text-right font-serif font-semibold text-foreground">Shares</th>
				<th class="hidden px-4 py-3 text-right font-serif font-semibold text-foreground md:table-cell">Avg Cost</th>
				...
				<th class="hidden px-4 py-3 text-right font-serif font-semibold text-foreground sm:table-cell">P&amp;L %</th>
			</tr>
		</thead>
		<tbody>
			{#each holdings as h}
